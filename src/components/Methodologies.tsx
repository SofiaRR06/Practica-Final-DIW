    ...
    <div className="bg-white mx-auto px-4 py-10 mt-20 rounded-2xl" >
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        <div className="flex-1 space-y-4 text-blue text-justify text-lg">
          ...
          Kanban nos ayuda a visualizar el flujo de trabajo y priorizar tareas, mientras que Scrum
          organiza proyectos complejos en sprints, fomentando la colaboración y la entrega rápida de resultados. <br/><br />
